# TICKET-021 - Mode switcher / orchestrator
...
- Define the state machine:
  ...
  - Transitions:
    ...
    - Hotkey `Ctrl+Alt+M` toggles `meeting` <-> previous mode (used by TICKET-023 for mute).
...
- Refactor references:
  ...
  - TICKET-022 builds on this directly.
...
- The orchestrator is the only place that knows which pipelines exist. This keeps TICKET-011/012/022 from having to know about each other.
